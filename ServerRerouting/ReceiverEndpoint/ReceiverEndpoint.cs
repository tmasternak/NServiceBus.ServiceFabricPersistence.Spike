...
namespace ReceiverEndpoint
{
    ...
    /// </summary>
    internal sealed class ReceiverEndpoint : StatefulService
    {
        public ReceiverEndpoint(StatefulServiceContext context)
            : base(context)
        { }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                var configuration = new EndpointConfiguration("AAA-ReceiverEndpoint");
                ...
                configuration.RegisterComponents(c => c.RegisterSingleton(StateManager));

                var partitionName = ((NamedPartitionInformation)base.Partition.PartitionInfo).Name;

                configuration.MakeInstanceUniquelyAddressable(partitionName);
